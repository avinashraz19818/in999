                  ...
                  <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>" . $row["utr"] . "</td>";
                            echo "<td><a href='https://in999.club9.eu.cc/uploads/" . $row["file_upload"] . "'>" . $row["file_upload"] . "</a></td>";
                            echo "<td><a href='https://in999.club9.eu.cc/uploads/" . $row["image_upload"] . "'>" . $row["image_upload"] . "</a></td>";
