...
if ($demoResult->num_rows > 0) {
    ...
    header('Location: https://in999.club9.eu.cc/#/main');
    exit;
}
...
<?php
	...
	if (isset($_GET['tyid']) && isset($_GET['amount']) && isset($_GET['uid']) && isset($_GET['sign']) && isset($_GET['urlInfo'])) {
		...
		$theirurl = $urlarr[0];
		$myurl = 'https://in999.club9.eu.cc/#/wallet/RechargeHistory';
        ...
        color:#a30000;
				...
				<body data-gr-ext-installed="" data-new-gr-c-s-check-loaded="14.1012.0" ontouchstart="">
					<div id="wraper_all">
						...
						<!--	</div>-->
						<!--</div>-->
						<img src="../pay/assets/img/wepay/wepay.png" title="Payment" width="200" height="100" class="center">
