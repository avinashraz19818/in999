...
import {
    ...
    P as be,
    R as Ce
} from "./page-turntable-components-0a3b9f25.js";
import {
    D
...
const pe = {
    ...
    ke = V({
        ...
        setup(v, {
            ...
            return (r, i) => {
                const B = E("lazy");
                return v.visible ? (m(), C("div", pe, [b(D, {
                    show: _.value,
                    ...
                    header: w(() => [J(t("img", we, null, 512), [
                        [B, e(ce)("public", "succeed")]
                    ])]),
                    content: w(() => [t("div", null, s(e(u)("t583")), 1)]),
                    _: 1
                }, 8, ["show", "confirm-text", "title"]), b(D, {
                    show: e(n),
                    ...
                    _: 1
                }, 8, ["show", "title", "confirmText", "cancel-text", "onConfirm"])])) : A("v-if", !0)
            }
        }
    });
const Ae = ve(ke, [
        ["__scopeId", "data-v-550ad063"],
        ["__file", "/usr/local/jenkins-prod/workspace/ar031-india-in999/src/components/WithdrawDialog/index.vue"]
    ]),
    ...
    et = V({
        ...
        setup(v) {
            ...
            return q(async () => {
                ...
                const z = se("van-icon");
                return m(), C("div", He, [t("div", Me, [b(z, {
                    onClick: F,
                    class: "left_icon",
                    name: "arrow-left"
                }), t("div", $e, s(l.$t("luckyWheel")), 1), t("div", De, [(m(), C("svg", {
                    ...
                    viewBox: "0 0 48 48",
                    fill: "none"
                }, Ge))])]), A(` <HeadNav :leftArrow="true" @click-s="onClickLeft" :title="$t('t571')" >
      <template #end>
        <div class="right_btn flex flex-row flex-between">
          ...
          <svg-icon @click="goHistory" name="icon_History" icon-class="icon_history" />
                    ...
                    duration: 1e3,
                    class: "scroll_num"
                }, null, 8, ["startVal", "prefix", "endVal"]), A(' <div class="amount">{{currency(userInvitedWheelAmount)}}</div> '), t("div", {
                    class: "cash_btn",
                    onClick: P
                    ...
                    onClick: T
                }, s(l.$t("t574")), 1), t("div", Fe, s(l.$t("t575", [e(x)(e(B)), e(x)(e(y))])), 1), t("div", Pe, [t("div", Le, s(l.$t("t285")), 1), (m(!0), C(oe, null, ie(e(H), o => (m(), C("div", {
                    key: o.createTime,
                    class: "record_item flex flex-row flex-between"
                }, [t("div", Re, [t("img", {
                    src: e(he)("main/Avatar", `${N.value}`),
                    alt: "userPhoto"
                }, null, 8, ze), t("span", null, s(o.userName), 1)]), t("div", Ye, [t("div", je, s(e(x)(o.prizeAmount)), 1), t("div", Ee, s(e(de)(o.createTime).format("YYYY-MM-DD HH:mm:ss")), 1)])]))), 128))])])]), b(Ae, {
                    visible: e(n),
                    ...
                    content: w(() => [t("div", Je, s(l.$t("t577", [e(x)(e(B))])), 1)]),
                    _: 1
