...
const b = _ => (G("data-v-82bb7bc5"), _ = _(), x(), _),
    J = {
        class: "package"
    },
    K = {
    ...
    b2 = D({
        ...
        setup(_) {
            ...
            return N(() => {
                ...
                const Z = M("NavBar"),
                    I = M("svg-icon");
                return a(), o("div", J, [k(Z, {
                    title: n.$t("activityDestitle"),
                    placeholder: !1,
                    "left-arrow": "",
                    onClickLeft: $
                }, null, 8, ["title"]), e("div", K, [e("div", Q, [e("h3", null, t(n.$t("newMenberPackage")), 1), e("h4", null, t(n.$t("newMenberTip")) + "：", 1), e("p", null, [U, p(t(n.$t("newMenberRule")), 1)]), e("p", null, [q, p(t(n.$t("newMenberRule2")), 1)]), e("div", null, [e("div", {
                    class: "package-desc",
                    onClick: H
                }, t(n.$t("activityDestitle")), 1)])])]), s(d).firstDepositConfig ? (a(), O(E, {
                    key: 0,
                    name: n.$t("activityTime"),
                    tiplist: []
                }, {
                    default: z(() => [e("h2", W, t(s(L) || n.$t("lotteryActivityUnstarted")), 1)]),
                    _: 1
                }, 8, ["name"])) : u("v-if", !0), s(d).firstDepositConfig ? (a(), o("div", X, [e("div", Y, [e("div", e2, t(n.$t("conditionsRule")), 1), e("div", t2, t(n.$t("afterDayBonus")), 1), e("div", s2, t(n.$t("bonusLimit")), 1)]), e("ul", null, [e("li", null, [e("div", null, t(n.$t("newMemberDeposit")), 1), e("div", i2, [e("p", {
                    innerHTML: n.$t("todayBonus", [s(B)])
                }, null, 8, n2)]), e("div", null, [e("span", null, t(s(v)(s(y))), 1)])])])])) : u("v-if", !0), s(d).firstDepositConfig.rewardState == 0 ? (a(), o("div", a2, [k(I, {
                    name: "activityNote"
                }), p(" " + t(s(d).firstDepositConfig.isAutomaticDistribution ? n.$t("receiveTips") : n.$t("activityTip9")), 1)])) : u("v-if", !0), [0, 4].includes(s(d).firstDepositConfig.rewardState) ? u("v-if", !0) : (a(), o("div", o2, t(S[s(d).firstDepositConfig.rewardState]), 1)), [4].includes(s(d).firstDepositConfig.rewardState) ? (a(), o("div", {
                    key: 4,
                    onClick: A[0] || (A[0] = (...l) => s(C) && s(C)(...l)),
                    class: "package-item-btn d"
                }, t(S[s(d).firstDepositConfig.rewardState]), 1)) : u("v-if", !0), e("ul", l2, [(a(!0), o(m, null, V(s(h), l => (a(), o("li", {
                    class: "package-item",
                    key: l.id
                }, [e("div", c2, [e("p", null, t(n.$t("registrationFull", [l.registerDays])), 1)]), e("div", r2, [e("div", d2, [e("ul", null, [e("li", u2, [e("h3", null, t(s(v)(l.actualGrandTotalDeposit)), 1), p2, e("p", null, t(n.$t("grandTotalDeposit")), 1)]), e("li", _2, [e("h3", null, t(s(v)(l.actualTotalValidBet)), 1), C2, e("p", null, t(n.$t("totalValidBet")), 1)])]), e("div", v2, [e("span", null, t(n.$t("giftBonus")), 1), e("span", null, t(s(v)(l.giveAwayBonus)), 1)])]), e("div", g2, t(w[l.state]), 1)]), l.state === 3 ? (a(), o("div", {
                    key: 0,
                    class: "package-item-btn",
                    onClick: F => s(g)(l.id)
                }, t(n.$t("receive")), 9, f2)) : u("v-if", !0), l.state === 0 && l.operateState === 2 ? (a(), o("div", {
                    key: 1,
                    class: "package-item-btn apply",
                    onClick: F => s(r)(l.id)
                }, t(n.$t("activityApply")), 9, h2)) : u("v-if", !0), l.state === 0 && [0, 1].includes(l.operateState) ? (a(), o("div", k2, t(w[0]), 1)) : u("v-if", !0), [0, 3].includes(l.state) ? u("v-if", !0) : (a(), o("div", m2, t(w[l.state]), 1))]))), 128))])])
            }
        }
    });
const L2 = T(b2, [
        ["__scopeId", "data-v-82bb7bc5"],
        ["__file", "/usr/local/jenkins-prod/workspace/ar031-india-in999/src/views/activity/MemberPackage/index.vue"]
    ]),
    ...
    S2 = D({
        ...
        setup(_) {
            ...
            return (c, f) => (a(!0), o(m, null, V(_.giftPackConfigList, (r, g) => (a(), o("div", {
                key: g
            }, [e("div", y2, t(c.$t("registrationFullTip", [r.registerDays])), 1), e("table", $2, [e("thead", w2, [e("th", null, t(c.$t("activeObject")), 1), e("th", null, t(c.$t("totalValidBets")), 1), e("th", null, t(c.$t("giftBonus")), 1)]), e("tbody", null, [(a(!0), o(m, null, V(r.configAwardList, (C, d) => (a(), o("tr", M2, [g >= d && d === 0 ? (a(), o("td", V2, t(c.$t("registrationDepositTip", [r.registerDays, r.grandTotalDeposit])), 1)) : u("v-if", !0), e("td", null, t(s(v)(C.totalValidBet)) + "+", 1), e("td", null, t(s(v)(C.giveAwayBonus)), 1)]))), 256))])]), r.configAwardList.length ? (a(), o("div", D2, [e("div", T2, [e("div", B2, t(c.$t("forexample")) + ":", 1)]), e("div", {
                class: "description",
...
const A2 = T(S2, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/ar031-india-in999/src/components/common/RulesTable.vue"]
    ]),
    R2 = {
    ...
    x2 = D({
        ...
        setup(_) {
            ...
            return N(() => {
                ...
                }, null, 8, ["title"]), e("div", R2, [s(r).firstDepositConfig ? (a(), o("div", P2, [e("div", N2, [e("div", j2, t(s(i)("newMenberRule")), 1)]), e("div", Z2, [p(t(s(i)("activityTime")), 1), e("span", null, t(s(g)), 1), p("，" + t(s(i)("newMemberDeposit")), 1), e("span", I2, t(s(C)), 1), p(t(s(i)("newMemberDepositTime")) + " ", 1), e("span", {
                    innerHTML: s(i)("platformBonus", [s(L)])
                }, null, 8, F2), p("，" + t(s(i)("bonusLimit")), 1), e("span", O2, t(s(v)(s(d))), 1), p("，" + t(s(i)("receiveTips")) + "。 ", 1)])])) : u("v-if", !0), e("div", z2, [e("div", G2, t(s(i)("newMemberPlayGame")), 1), e("div", null, [k(A2, {
...
const E2 = T(x2, [
        ...
        ["__file", "/usr/local/jenkins-prod/workspace/ar031-india-in999/src/views/activity/MemberPackage/Rules/index.vue"]
    ]),
